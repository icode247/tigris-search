...
goog.exportSymbol('proto.HealthCheckInput', null, global);
 ...
 * @constructor
 */
proto.HealthCheckInput = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.HealthCheckInput, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.HealthCheckInput.displayName = 'proto.HealthCheckInput';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.HealthCheckInput.prototype.toObject = function(opt_includeInstance) {
  return proto.HealthCheckInput.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.HealthCheckInput} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.HealthCheckInput.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.HealthCheckInput}
 */
proto.HealthCheckInput.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.HealthCheckInput;
  return proto.HealthCheckInput.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.HealthCheckInput} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.HealthCheckInput}
 */
proto.HealthCheckInput.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.HealthCheckInput.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.HealthCheckInput.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.HealthCheckInput} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.HealthCheckInput.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {string}
 */
proto.HealthCheckResponse.prototype.getResponse = function() {
 ...
 */
proto.HealthCheckResponse.prototype.setResponse = function(value) {
