...
class Session {
    constructor(id, origin, grpcClient, db, additionalMetadata) {
        this._id = id;
        this._origin = origin;
    ...
    commit() {
        return new Promise((resolve, reject) => {
            const request = new api_pb_1.CommitTransactionRequest().setDb(this.db);
    ...
    rollback() {
        return new Promise((resolve, reject) => {
            const request = new api_pb_1.RollbackTransactionRequest().setDb(this.db);
